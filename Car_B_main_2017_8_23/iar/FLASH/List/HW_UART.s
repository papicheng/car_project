///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.50.1.10123/W32 for ARM      23/Aug/2017  10:35:07
// Copyright 1999-2015 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        G:\study\car\program\lib_and_example\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_UART.c
//    Command line =  
//        G:\study\car\program\lib_and_example\LPLD_OSKinetis_V3\lib\LPLD\HW\HW_UART.c
...
//        ARM_MATH_CM4
//    List file    =  
//        G:\study\car\program\lib_and_example\LPLD_OSKinetis_V3\project\Car_B_main_2017_8_23\iar\FLASH\List\HW_UART.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   61   if(uartx == UART0)
??LPLD_UART_Init_0:
        LDR.W    R4,??DataTable11_2  ;; 0x4006a000
        CMP      R0,R4
...
//   65     SIM->SCGC4 |= SIM_SCGC4_UART0_MASK;
        LDR.W    R12,??DataTable11_4  ;; 0x40048034
        LDR      R12,[R12, #+0]
        ORRS     R12,R12,#0x400
        LDR.W    LR,??DataTable11_4  ;; 0x40048034
        STR      R12,[LR, #+0]
//   66     
//   67     if(tx_pin == PTA2)
...
//   68       PORTA->PCR[2] = PORT_PCR_MUX(2); 
        MOV      R7,#+512
        LDR.W    R12,??DataTable11_5  ;; 0x40049008
        STR      R7,[R12, #+0]
...
//   70       PORTA->PCR[14] = PORT_PCR_MUX(3); 
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_6  ;; 0x40049038
        STR      R7,[R12, #+0]
        B.N      ??LPLD_UART_Init_3
//   71     else
...
??LPLD_UART_Init_4:
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_7  ;; 0x4004a044
        STR      R7,[R12, #+0]
//   73     
//   74     if(rx_pin == PTA1)
??LPLD_UART_Init_3:
...
//   75       PORTA->PCR[1] = PORT_PCR_MUX(2); 
        MOV      R5,#+512
        LDR.W    R7,??DataTable11_8  ;; 0x40049004
        STR      R5,[R7, #+0]
...
//   77       PORTA->PCR[15] = PORT_PCR_MUX(3); 
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_9  ;; 0x4004903c
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
//   78     else
...
??LPLD_UART_Init_7:
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_10  ;; 0x4004a040
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
//   80   }
//   81   else
...
//   83     if (uartx == UART1)
??LPLD_UART_Init_1:
        LDR.W    R4,??DataTable11_11  ;; 0x4006b000
        CMP      R0,R4
...
//   90         PORTE->PCR[0] = PORT_PCR_MUX(3); 
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_12  ;; 0x4004d000
        STR      R7,[R12, #+0]
...
??LPLD_UART_Init_9:
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_13  ;; 0x4004b010
        STR      R7,[R12, #+0]
//   93       
//   94       if(rx_pin == PTE1)
??LPLD_UART_Init_10:
...
//   95         PORTE->PCR[1] = PORT_PCR_MUX(3); 
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_14  ;; 0x4004d004
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
//   96       else
...
??LPLD_UART_Init_11:
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_15  ;; 0x4004b00c
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
//   98     }
//   99     else
...
??LPLD_UART_Init_8:
        ...
        LDR      R6,[R4, #+0]
//  102       if (uartx == UART2)
        LDR.W    R4,??DataTable11_17  ;; 0x4006c000
        CMP      R0,R4
...
//  105         SIM->SCGC4 |= SIM_SCGC4_UART2_MASK;
        LDR.W    R5,??DataTable11_4  ;; 0x40048034
        LDR      R5,[R5, #+0]
        ORRS     R5,R5,#0x1000
        LDR.W    R7,??DataTable11_4  ;; 0x40048034
        STR      R5,[R7, #+0]
//  106         
//  107         PORTD->PCR[3] = PORT_PCR_MUX(3); 
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_18  ;; 0x4004c00c
        STR      R5,[R7, #+0]
//  108         PORTD->PCR[2] = PORT_PCR_MUX(3);
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_19  ;; 0x4004c008
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
//  109       }
//  110       else
...
//  112         if(uartx == UART3)
??LPLD_UART_Init_12:
        LDR.W    R4,??DataTable11_20  ;; 0x4006d000
        CMP      R0,R4
...
//  118             PORTE->PCR[4] = PORT_PCR_MUX(3); 
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_21  ;; 0x4004d010
        STR      R7,[R12, #+0]
...
//  120             PORTB->PCR[11] = PORT_PCR_MUX(3); 
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_22  ;; 0x4004a02c
        STR      R7,[R12, #+0]
        B.N      ??LPLD_UART_Init_15
//  121           else 
...
??LPLD_UART_Init_16:
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_23  ;; 0x4004b044
        STR      R7,[R12, #+0]
//  123           
//  124           if(rx_pin == PTE5)
??LPLD_UART_Init_15:
...
//  125             PORTE->PCR[5] = PORT_PCR_MUX(3); 
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_24  ;; 0x4004d014
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
...
//  127             PORTB->PCR[10] = PORT_PCR_MUX(3); 
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_25  ;; 0x4004a028
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
//  128           else
...
??LPLD_UART_Init_18:
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_26  ;; 0x4004b040
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
//  130         }
//  131         else
...
//  133           if(uartx == UART4)
??LPLD_UART_Init_13:
        LDR.W    R4,??DataTable11_27  ;; 0x400ea000
        CMP      R0,R4
...
//  136             SIM->SCGC1 |= SIM_SCGC1_UART4_MASK;
        LDR.W    R12,??DataTable11_28  ;; 0x40048028
        LDR      R12,[R12, #+0]
        ORRS     R12,R12,#0x400
        LDR.W    LR,??DataTable11_28  ;; 0x40048028
        STR      R12,[LR, #+0]
//  137             
//  138             if(tx_pin == PTE24)
        UXTB     R7,R7            ;; ZeroExt  R7,R7,#+24,#+24
...
//  139               PORTE->PCR[24] = PORT_PCR_MUX(3); 
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_29  ;; 0x4004d060
        STR      R7,[R12, #+0]
...
??LPLD_UART_Init_20:
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_30  ;; 0x4004b03c
        STR      R7,[R12, #+0]
//  142             
//  143             if(rx_pin == PTE25)
??LPLD_UART_Init_21:
...
//  144               PORTE->PCR[25] = PORT_PCR_MUX(3); 
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_31  ;; 0x4004d064
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
//  145             else
...
??LPLD_UART_Init_22:
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_32  ;; 0x4004b038
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
//  147           }
//  148           else
...
??LPLD_UART_Init_19:
        MOVS     R4,#+5
//  151             uartx = UART5;
        LDR.W    R0,??DataTable11_33  ;; 0x400eb000
...
//  155               PORTD->PCR[9] = PORT_PCR_MUX(3); 
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_34  ;; 0x4004c024
        STR      R7,[R12, #+0]
...
??LPLD_UART_Init_23:
        MOV      R7,#+768
        LDR.W    R12,??DataTable11_35  ;; 0x4004d020
        STR      R7,[R12, #+0]
//  158             
//  159             if(rx_pin == PTD8)
??LPLD_UART_Init_24:
...
//  160               PORTD->PCR[8] = PORT_PCR_MUX(3); 
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_36  ;; 0x4004c020
        STR      R5,[R7, #+0]
        B.N      ??LPLD_UART_Init_6
//  161             else
...
??LPLD_UART_Init_25:
        MOV      R5,#+768
        LDR.W    R7,??DataTable11_37  ;; 0x4004d024
        STR      R5,[R7, #+0]
//  163           }
//  164         }
//  165       }
...
//  458   if(uart_init_structure.UART_Uartx == UART0)
        LDR      R0,[SP, #+8]
        LDR.W    R1,??DataTable11_2  ;; 0x4006a000
        CMP      R0,R1
...
??LPLD_UART_EnableIrq_0:
        LDR      R0,[SP, #+8]
        LDR.W    R1,??DataTable11_11  ;; 0x4006b000
        CMP      R0,R1
...
??LPLD_UART_EnableIrq_2:
        LDR      R0,[SP, #+8]
        LDR.W    R1,??DataTable11_17  ;; 0x4006c000
        CMP      R0,R1
...
??LPLD_UART_EnableIrq_3:
        LDR      R0,[SP, #+8]
        LDR.W    R1,??DataTable11_20  ;; 0x4006d000
        CMP      R0,R1
...
??LPLD_UART_EnableIrq_4:
        LDR      R0,[SP, #+8]
        LDR.W    R1,??DataTable11_27  ;; 0x400ea000
        CMP      R0,R1
...
??LPLD_UART_EnableIrq_5:
        LDR      R0,[SP, #+8]
        LDR.W    R1,??DataTable11_33  ;; 0x400eb000
        CMP      R0,R1
...
//  505   if(uart_init_structure.UART_Uartx == UART0)
        LDR      R0,[SP, #+8]
        LDR.N    R1,??DataTable11_2  ;; 0x4006a000
        CMP      R0,R1
...
??LPLD_UART_DisableIrq_0:
        LDR      R0,[SP, #+8]
        LDR.N    R1,??DataTable11_11  ;; 0x4006b000
        CMP      R0,R1
...
??LPLD_UART_DisableIrq_2:
        LDR      R0,[SP, #+8]
        LDR.N    R1,??DataTable11_17  ;; 0x4006c000
        CMP      R0,R1
...
??LPLD_UART_DisableIrq_3:
        LDR      R0,[SP, #+8]
        LDR.N    R1,??DataTable11_20  ;; 0x4006d000
        CMP      R0,R1
...
??LPLD_UART_DisableIrq_4:
        LDR      R0,[SP, #+8]
        LDR.N    R1,??DataTable11_27  ;; 0x400ea000
        CMP      R0,R1
...
??LPLD_UART_DisableIrq_5:
        LDR      R0,[SP, #+8]
        LDR.N    R1,??DataTable11_33  ;; 0x400eb000
        CMP      R0,R1
...
//  547   if( UART0->SFIFO & UART_SFIFO_RXUF_MASK)
        LDR.N    R0,??DataTable11_41  ;; 0x4006a012
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+31
...
//  549     UART0->SFIFO |= UART_SFIFO_RXUF_MASK;
        ...
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.N    R1,??DataTable11_41  ;; 0x4006a012
        STRB     R0,[R1, #+0]
//  550   }
...
??UART0_IRQHandler_1:
        LDR.N    R0,??DataTable11_42  ;; 0x4006a004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART0_IRQHandler_2
        LDR.N    R0,??DataTable11_43  ;; 0x4006a003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART0_IRQHandler_2
//  558   {
//  559     UART_R_ISR[0]();
        LDR.N    R0,??DataTable11_38
        LDR      R0,[R0, #+0]
        BLX      R0
//  560   }
//  561   //进入发送中断函数
...
//  582   if( UART1->SFIFO & UART_SFIFO_RXUF_MASK)
        LDR.N    R0,??DataTable11_44  ;; 0x4006b012
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+31
...
//  584     UART1->SFIFO |= UART_SFIFO_RXUF_MASK;
        ...
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.N    R1,??DataTable11_44  ;; 0x4006b012
        STRB     R0,[R1, #+0]
//  585   }
...
??UART1_IRQHandler_1:
        LDR.N    R0,??DataTable11_45  ;; 0x4006b004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART1_IRQHandler_2
        LDR.N    R0,??DataTable11_46  ;; 0x4006b003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART1_IRQHandler_2
//  593   {
...
//  617   if( UART2->SFIFO & UART_SFIFO_RXUF_MASK)
        LDR.N    R0,??DataTable11_47  ;; 0x4006c012
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+31
...
//  619     UART2->SFIFO |= UART_SFIFO_RXUF_MASK;
        ...
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.N    R1,??DataTable11_47  ;; 0x4006c012
        STRB     R0,[R1, #+0]
//  620   }
...
??UART2_IRQHandler_1:
        LDR.N    R0,??DataTable11_48  ;; 0x4006c004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART2_IRQHandler_2
        LDR.N    R0,??DataTable11_49  ;; 0x4006c003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART2_IRQHandler_2
//  628   {
...
//  652   if( UART3->SFIFO & UART_SFIFO_RXUF_MASK)
        LDR.N    R0,??DataTable11_50  ;; 0x4006d012
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+31
...
//  654     UART3->SFIFO |= UART_SFIFO_RXUF_MASK;
        ...
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.N    R1,??DataTable11_50  ;; 0x4006d012
        STRB     R0,[R1, #+0]
//  655   }
...
??UART3_IRQHandler_1:
        LDR.N    R0,??DataTable11_51  ;; 0x4006d004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART3_IRQHandler_2
        LDR.N    R0,??DataTable11_52  ;; 0x4006d003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART3_IRQHandler_2
//  663   {
...
//  687   if( UART4->SFIFO & UART_SFIFO_RXUF_MASK)
        LDR.N    R0,??DataTable11_53  ;; 0x400ea012
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+31
...
//  689     UART4->SFIFO |= UART_SFIFO_RXUF_MASK;
        ...
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.N    R1,??DataTable11_53  ;; 0x400ea012
        STRB     R0,[R1, #+0]
//  690   }
...
??UART4_IRQHandler_1:
        LDR.N    R0,??DataTable11_54  ;; 0x400ea004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART4_IRQHandler_2
        LDR.N    R0,??DataTable11_55  ;; 0x400ea003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART4_IRQHandler_2
//  698   {
...
//  722   if( UART5->SFIFO & UART_SFIFO_RXUF_MASK)
        LDR.N    R0,??DataTable11_56  ;; 0x400eb012
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+31
...
//  724     UART5->SFIFO |= UART_SFIFO_RXUF_MASK;
        ...
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.N    R1,??DataTable11_56  ;; 0x400eb012
        STRB     R0,[R1, #+0]
//  725   }
...
??UART5_IRQHandler_1:
        LDR.N    R0,??DataTable11_57  ;; 0x400eb004
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART5_IRQHandler_2
        LDR.N    R0,??DataTable11_58  ;; 0x400eb003
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+26
        BPL.N    ??UART5_IRQHandler_2
//  733   {
